      ...
      <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="div_center">
                ...
                <input class="text_color" type="text" name="dis_price" placeholder="Write a discount price" value="<?php echo e($product->discount_price); ?>">
                </div>
                <div class="div_design">
                <label>Product Vendor:</label>
                <input class="text_color" type="text" name="vendor" placeholder="Write a vendor" required="" value="<?php echo e($product->vendor); ?>">
                </div>
                <div class="div_design">
                <label>New:</label>
                <input class="text_color" type="text" name="new" placeholder="Write 1 if new" required="" value="<?php echo e($product->new); ?>">
                </div>
                <div class="div_design">
...
</html><?php /**PATH C:\Users\Vulln\Desktop\tessaweb\resources\views/admin/update_product.blade.php ENDPATH**/ ?>