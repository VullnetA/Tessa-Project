...
<html lang="zxx">
  ...
  <body>
    ...
    <!-- Start Page Title -->
    <?php echo $__env->make('cart.pageTitle', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- End Page Title -->

    <!-- Start Cart Area -->
    <?php echo $__env->make('cart.cartArea', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- End Cart Area -->
...
<?php /**PATH C:\Users\Luka\Desktop\Preparations\tessaweb\tessaweb\tessaweb\resources\views/cart/showcart.blade.php ENDPATH**/ ?>