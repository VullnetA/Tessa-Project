              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12">
                  ...
                  <?php if(auth()->guard()->check()): ?>
                    ...
                    <li>
                        <button class="button-dalje" role="button"><span href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        Log out
                      </span></button>
            ...
            <div class="d-table">
                <div class="d-table-cell">
                    ...
                    <div class="search-overlay-form">
                        <form action="<?php echo e(url('searchuser')); ?>" method="get">
...
<?php /**PATH C:\xampp\htdocs\tessaweb1\resources\views/home/header.blade.php ENDPATH**/ ?>