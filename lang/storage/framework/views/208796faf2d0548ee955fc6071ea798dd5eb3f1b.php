...
<?php $__env->startSection('stickynavbar'); ?>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img7.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover7.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img8.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover8.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img9.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover9.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img10.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover10.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img11.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover11.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 products-col-item">
                <div class="single-products-box">
                  <div class="products-image">
                    <a href="#">
                      <img
                        src="assets/img/products/img12.jpg"
                        class="main-image"
                        alt="image"
                      />
                      <img
                        src="assets/img/products/img-hover12.jpg"
                        class="hover-image"
                        alt="image"
                      />
                    </a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Luka\Desktop\Preparations\tessaweb\tessaweb\resources\views/shop.blade.php ENDPATH**/ ?>